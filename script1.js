...
if (couponCode === "DISCOUNT10") {
    ...
    var discountedBill = totalBill * 0.9;


    document.getElementById('discountMessage').innerHTML = "Discount applied! Total amount after discount: " + discountedBill;
    document.getElementById('discountMessage').classList.add("discount");


} else {

    document.getElementById('discountMessage').innerHTML = "Invalid coupon code";
}
}
